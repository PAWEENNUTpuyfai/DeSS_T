        ...
        <div className="flex gap-4">
              ...
              <div className="mt-4 p-4 w-full h-[85vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto space-y-4 pr-2">
                  {routes.map((r, idx) => {
                    ...
                    const isDisabled = isLocked || isOtherRouteBeingEdited;
                    const bodyStyle = {
                      ...
                      >
                        ...
                        <div className="flex">
                          ...
                          <div
                            ...
                            style={{
                              backgroundColor: r.locked ? "#9B9B9B" : "#81069E",
                            }}
                          >
                            {!isBeingEdited && (
                              <span
                          ...
                          >
                            ...
                            />
                            {openColorPickerId === r.id && !isDisabled && (
                              <div
                                ref={colorPickerRef}
                              ...
                              {expandedStationRoutes.has(r.id) ? (
                                <>
                                  ...
                                  <span
                                    role="button"
                                    tabIndex={0}
                                    onClick={() => toggleStationExpand(r.id)}
                                    onKeyDown={(e) =>
                                      e.key === "Enter" &&
          ...
          <div className="map-container flex-1 h-[90vh] flex flex-col items-center px-16">
            ...
            <div className="mb-4 mt-6 flex justify-end w-full">
              <button className="btn_primary px-8">Simulation</button>
            </div>
          </div>
        </div>
      </div>
