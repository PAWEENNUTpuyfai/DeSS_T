...
interface RouteCardProps {
  ...
  isOtherRouteBeingEdited: boolean;
  ...
  onCancelEdit: () => void;
  onRemove: () => void;
  onUpdateColor: (color: ColorResult) => void;
  ...
  return (
    ...
    >
      ...
      <div className="flex">
        ...
        >
          {!isBeingEdited && (
            <span
              ...
              onKeyDown={(e) => e.key === "Enter" && onToggleLock()}
            >
        ...
        {/* Right: Color, Name, Eye, Edit, Delete */}
        <div
        ...
        >
          <span
            ...
            onClick={() => !isDisabled && onToggleColorPicker()}
            onKeyDown={(e) =>
              e.key === "Enter" && !isDisabled && onToggleColorPicker()
            }
          ...
          <ColorPickerPopover
            isOpen={openColorPicker && !isDisabled}
            color={route.color}
          ...
          {isBeingEdited ? (
            <>
              {isFetchingSegment ? (
                ...
                <>
                  <span role="button" onClick={onConfirmEdit}>
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                  ...
                  <span role="button" onClick={onCancelEdit}>
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
            ...
            <>
              <span
                ...
                onKeyDown={(e) => e.key === "Enter" && onToggleHide()}
              >
                {route.hidden ? (
                  <svg
                    width="24"
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="#CBCBCB"
                    />
                    <path d="M5 2L21 18" stroke="#CBCBCB" strokeWidth="2" />
                  </svg>
                ) : (
                  <svg
                    width="24"
              ...
              <span
                ...
                onKeyDown={(e) => e.key === "Enter" && !isDisabled && onEdit()}
                aria-disabled={isDisabled}
              >
                <svg
                  width="20"
              ...
              <span
                ...
                onKeyDown={(e) =>
                  e.key === "Enter" && !isDisabled && onRemove()
                }
                aria-disabled={isDisabled}
              >
                <svg
          ...
          <>
            {isExpanded ? (
              <>
                ...
                {route.stations.map((s, sIdx) => (
                  <React.Fragment key={`${route.id}-st-${sIdx}`}>
                    <span className="font-medium text-center">
                      {getStationName(s)}
                    </span>
                    {sIdx < route.stations.length - 1 && (
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
              ...
              >
                ...
                Show more ({route.stations.length} stations)
              </span>
            )}
          </>
        ) : (
